...
{
	static const char* forward_delimiter()
	{
		return "->";
	}
	static const char* reverse_delimiter()
	{
		return "<-";
	}
	static const char* incomplete_marker()
	{
		return "...";
	}
...
{
	static const wchar_t* forward_delimiter()
	{
		return L"->";
	}
	static const wchar_t* reverse_delimiter()
	{
		return L"<-";
	}
	static const wchar_t* incomplete_marker()
	{
		return L"...";
	}
	static const wchar_t* empty_marker()
	{
		return L"";
	}
};
