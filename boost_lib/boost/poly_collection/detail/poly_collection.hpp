...
public:
	...
	public:
		...
		const_local_base_iterator cbegin()const noexcept
		{
			return begin();
		}
		const_local_base_iterator cend()const noexcept
		{
			return end();
		}
		...
		template<typename T>
		const_local_iterator<T> cbegin()const noexcept
		{
			return begin<T>();
		}
		template<typename T>
		const_local_iterator<T> cend()const noexcept
		{
			return end<T>();
		}
	...
	protected:
		...
		const_base_segment_info(const_segment_map_iterator it)noexcept:it
		{
			it
		} {}
	...
	protected:
		...
		const_segment_info(const_segment_map_iterator it)noexcept:it
		{
			it
		} {}
...
public:
	...
	public:
		...
		const_base_segment_info_iterator cbegin()const noexcept
		{
			return begin();
		}
		const_base_segment_info_iterator cend()const noexcept
		{
			return end();
		}
	...
	public:
		...
		base_segment_info_iterator begin()noexcept
		{
			return this->pmap->cbegin();
		}
		base_segment_info_iterator end()noexcept
		{
			return this->pmap->cend();
		}
