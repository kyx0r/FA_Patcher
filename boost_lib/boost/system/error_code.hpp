...
error_category() BOOST_SYSTEM_NOEXCEPT:
	std_cat_( this ) {}
...
public:
	...
	// constructors:
error_condition() BOOST_SYSTEM_NOEXCEPT :
...
:
	...
	// observers:
	int                     value() const BOOST_SYSTEM_NOEXCEPT
	{
		return m_val;
	}
	const error_category &  category() const BOOST_SYSTEM_NOEXCEPT
	{
		return *m_cat;
	}
