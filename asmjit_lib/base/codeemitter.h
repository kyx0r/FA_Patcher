...
public:
	...
	ASMJIT_INLINE CodeHolder* getCode() const noexcept
	{
		return _code;
	}
	...
	ASMJIT_INLINE bool is32Bit() const noexcept
	{
		return getArchInfo().is32Bit();
	}
	//! Get if the target architecture is 64-bit.
	ASMJIT_INLINE bool is64Bit() const noexcept
	{
		return getArchInfo().is64Bit();
	}
	...
	ASMJIT_INLINE bool isAssembler() const noexcept
	{
		return _type == kTypeAssembler;
	}
	ASMJIT_INLINE bool isCodeBuilder() const noexcept
	{
		return _type == kTypeBuilder;
	}
	ASMJIT_INLINE bool isCodeCompiler() const noexcept
	{
		return _type == kTypeCompiler;
	}
	...
	ASMJIT_INLINE bool isInErrorState() const noexcept
	{
		return _lastError != kErrorOk;
	}

	//! Get the last error code.
	ASMJIT_INLINE Error getLastError() const noexcept
	{
		return _lastError;
	}
	...
	ASMJIT_INLINE Error resetLastError() noexcept
	{
		return setLastError(kErrorOk);
	}
	...
	ASMJIT_INLINE void resetOptions() noexcept
	{
		_options = 0;
	}
