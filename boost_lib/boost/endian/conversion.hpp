...
{
public:
	T operator()(T x) BOOST_NOEXCEPT {return x;}
};
...
{
public:
	T operator()(T x) BOOST_NOEXCEPT {return endian_reverse(x);}
};
...
{
public:
	void operator()(T&) BOOST_NOEXCEPT {/*no effect*/}
};
...
{
public:
	void operator()(T& x) BOOST_NOEXCEPT { endian_reverse_inplace(x); }
};
