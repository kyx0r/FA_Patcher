...
public:
	...
	bool operator==(allocators const& a) const
	{
		return leaf_allocator() == a.leaf_allocator();
	}
	template <typename Alloc>
	bool operator==(Alloc const& a) const
	{
		return leaf_allocator() == leaf_allocator_type(a);
	}

	Allocator allocator() const
	{
		return Allocator(leaf_allocator());
	}
	...
	internal_node_allocator_type const& internal_node_allocator() const
	{
		return *this;
	}
	...
	leaf_allocator_type const& leaf_allocator() const
	{
		return *this;
	}
};
