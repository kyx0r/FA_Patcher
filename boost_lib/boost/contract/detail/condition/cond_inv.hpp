...
protected:
	...
	{
		check_inv(true, false, false);
	}
	void check_entry_static_inv()
	{
		check_inv(true, true, false);
	}
	void check_entry_all_inv()
	{
		check_inv(true, false, true);
	}
#endif
	...
	void check_exit_inv()
	{
		check_inv(false, false, false);
	}
	void check_exit_static_inv()
	{
		check_inv(false, true, false);
	}
	void check_exit_all_inv()
	{
		check_inv(false, false, true);
	}
#endif
