...
struct on_no_event
{
	enum { num = detail::on_no_event_num };
};
...
{
	enum { num = detail::on_start_vertex_num };
};
struct on_discover_vertex
{
	enum { num = detail::on_discover_vertex_num };
};
struct on_examine_vertex
{
	enum { num = detail::on_examine_vertex_num };
};
struct on_finish_vertex
{
	enum { num = detail::on_finish_vertex_num };
};
...
struct on_tree_edge
{
	enum { num = detail::on_tree_edge_num };
};
struct on_non_tree_edge
{
	enum { num = detail::on_non_tree_edge_num };
};
struct on_gray_target
{
	enum { num = detail::on_gray_target_num };
};
struct on_black_target
{
	enum { num = detail::on_black_target_num };
};
...
struct on_back_edge
{
	enum { num = detail::on_back_edge_num };
};
struct on_finish_edge
{
	enum { num = detail::on_finish_edge_num };
};

struct on_edge_relaxed
{
	enum { num = detail::on_edge_relaxed_num };
};
...
{
	enum { num = detail::on_edge_minimized_num };
};
