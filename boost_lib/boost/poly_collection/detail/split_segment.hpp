...
public:
	...
	std::size_t           nv_size()const noexcept
	{
		return s.size();
	}
	...
	std::size_t           nv_max_size()const noexcept
	{
		return s.max_size()-1;
	}
	...
	std::size_t           nv_capacity()const noexcept
	{
		return s.capacity();
	}
