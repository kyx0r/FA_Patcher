...
BOOST_FORCEINLINE BOOST_CONSTEXPR explicit aligned(type const& v) BOOST_NOEXCEPT :
		value(v) {}
	};
};
...
struct make_storage_type< 1u >
{
	...
	struct BOOST_ATOMIC_DETAIL_MAY_ALIAS aligned
	{
		...
		BOOST_DEFAULTED_FUNCTION(aligned(), {})
BOOST_FORCEINLINE BOOST_CONSTEXPR explicit aligned(type v) BOOST_NOEXCEPT :
		value(v) {}
	};
};
