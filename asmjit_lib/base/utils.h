...
template<> struct IntTraitsPrivate<1, 0>
{
	typedef int     IntType;
	typedef int8_t  SignedType;
	typedef uint8_t  UnsignedType;
};
template<> struct IntTraitsPrivate<1, 1>
{
	typedef int     IntType;
	typedef int8_t  SignedType;
	typedef uint8_t  UnsignedType;
...
template<> struct IntTraitsPrivate<2, 0>
{
	typedef int     IntType;
	typedef int16_t SignedType;
	typedef uint16_t UnsignedType;
};
template<> struct IntTraitsPrivate<2, 1>
{
	typedef int     IntType;
	typedef int16_t SignedType;
	typedef uint16_t UnsignedType;
...
template<> struct IntTraitsPrivate<4, 0>
{
	typedef int64_t IntType;
	typedef int32_t SignedType;
	typedef uint32_t UnsignedType;
};
template<> struct IntTraitsPrivate<4, 1>
{
	typedef int     IntType;
	typedef int32_t SignedType;
	typedef uint32_t UnsignedType;
...
template<> struct IntTraitsPrivate<8, 0>
{
	typedef int64_t IntType;
	typedef int64_t SignedType;
	typedef uint64_t UnsignedType;
};
template<> struct IntTraitsPrivate<8, 1>
{
	typedef int64_t IntType;
	typedef int64_t SignedType;
	typedef uint64_t UnsignedType;
...
static ASMJIT_INLINE int32_t floatAsInt(float f) noexcept
{
	FloatBits m;
	m.f = f;
	return m.i;
...
static ASMJIT_INLINE float intAsFloat(int32_t i) noexcept
{
	FloatBits m;
	m.i = i;
	return m.f;
...
static ASMJIT_INLINE int64_t doubleAsInt(double d) noexcept
{
	DoubleBits m;
	m.d = d;
	return m.i;
...
static ASMJIT_INLINE double intAsDouble(int64_t i) noexcept
{
	DoubleBits m;
	m.i = i;
	return m.d;
...
template<typename T>
static ASMJIT_INLINE T toLower(T c) noexcept
{
	return c ^ (static_cast<T>(c >= T('A') && c <= T('Z')) << 5);
}
template<typename T>
static ASMJIT_INLINE T toUpper(T c) noexcept
{
	return c ^ (static_cast<T>(c >= T('a') && c <= T('z')) << 5);
}
...
// \internal
static ASMJIT_INLINE uint32_t hashRound(uint32_t hash, uint32_t c) noexcept
{
	return hash * 65599 + c;
}
...
template<uint64_t In>
static ASMJIT_INLINE uint32_t firstBitOfT() noexcept
{
	return FirstBitOfTImpl<In>::kValue;
}
...
static ASMJIT_INLINE uint32_t readU16aLE(const void* p) noexcept
{
	return readU16xLE<2>(p);
}
static ASMJIT_INLINE uint32_t readU16uLE(const void* p) noexcept
{
	return readU16xLE<0>(p);
}

static ASMJIT_INLINE uint32_t readU16aBE(const void* p) noexcept
{
	return readU16xBE<2>(p);
}
static ASMJIT_INLINE uint32_t readU16uBE(const void* p) noexcept
{
	return readU16xBE<0>(p);
}

static ASMJIT_INLINE uint32_t readU16a(const void* p) noexcept
{
	return readU16x<2>(p);
}
static ASMJIT_INLINE uint32_t readU16u(const void* p) noexcept
{
	return readU16x<0>(p);
}

static ASMJIT_INLINE int32_t readI16aLE(const void* p) noexcept
{
	return readI16xLE<2>(p);
}
static ASMJIT_INLINE int32_t readI16uLE(const void* p) noexcept
{
	return readI16xLE<0>(p);
}

static ASMJIT_INLINE int32_t readI16aBE(const void* p) noexcept
{
	return readI16xBE<2>(p);
}
static ASMJIT_INLINE int32_t readI16uBE(const void* p) noexcept
{
	return readI16xBE<0>(p);
}

static ASMJIT_INLINE int32_t readI16a(const void* p) noexcept
{
	return readI16x<2>(p);
}
static ASMJIT_INLINE int32_t readI16u(const void* p) noexcept
{
	return readI16x<0>(p);
}
...
static ASMJIT_INLINE uint32_t readU32a(const void* p) noexcept
{
	return readU32x<4>(p);
}
static ASMJIT_INLINE uint32_t readU32u(const void* p) noexcept
{
	return readU32x<0>(p);
}

static ASMJIT_INLINE uint32_t readU32aLE(const void* p) noexcept
{
	return readU32xLE<4>(p);
}
static ASMJIT_INLINE uint32_t readU32uLE(const void* p) noexcept
{
	return readU32xLE<0>(p);
}

static ASMJIT_INLINE uint32_t readU32aBE(const void* p) noexcept
{
	return readU32xBE<4>(p);
}
static ASMJIT_INLINE uint32_t readU32uBE(const void* p) noexcept
{
	return readU32xBE<0>(p);
}

static ASMJIT_INLINE int32_t readI32a(const void* p) noexcept
{
	return readI32x<4>(p);
}
static ASMJIT_INLINE int32_t readI32u(const void* p) noexcept
{
	return readI32x<0>(p);
}

static ASMJIT_INLINE int32_t readI32aLE(const void* p) noexcept
{
	return readI32xLE<4>(p);
}
static ASMJIT_INLINE int32_t readI32uLE(const void* p) noexcept
{
	return readI32xLE<0>(p);
}

static ASMJIT_INLINE int32_t readI32aBE(const void* p) noexcept
{
	return readI32xBE<4>(p);
}
static ASMJIT_INLINE int32_t readI32uBE(const void* p) noexcept
{
	return readI32xBE<0>(p);
}
...
static ASMJIT_INLINE uint64_t readU64a(const void* p) noexcept
{
	return readU64x<8>(p);
}
static ASMJIT_INLINE uint64_t readU64u(const void* p) noexcept
{
	return readU64x<0>(p);
}

static ASMJIT_INLINE uint64_t readU64aLE(const void* p) noexcept
{
	return readU64xLE<8>(p);
}
static ASMJIT_INLINE uint64_t readU64uLE(const void* p) noexcept
{
	return readU64xLE<0>(p);
}

static ASMJIT_INLINE uint64_t readU64aBE(const void* p) noexcept
{
	return readU64xBE<8>(p);
}
static ASMJIT_INLINE uint64_t readU64uBE(const void* p) noexcept
{
	return readU64xBE<0>(p);
}

static ASMJIT_INLINE int64_t readI64a(const void* p) noexcept
{
	return readI64x<8>(p);
}
static ASMJIT_INLINE int64_t readI64u(const void* p) noexcept
{
	return readI64x<0>(p);
}

static ASMJIT_INLINE int64_t readI64aLE(const void* p) noexcept
{
	return readI64xLE<8>(p);
}
static ASMJIT_INLINE int64_t readI64uLE(const void* p) noexcept
{
	return readI64xLE<0>(p);
}

static ASMJIT_INLINE int64_t readI64aBE(const void* p) noexcept
{
	return readI64xBE<8>(p);
}
static ASMJIT_INLINE int64_t readI64uBE(const void* p) noexcept
{
	return readI64xBE<0>(p);
}
...
static ASMJIT_INLINE void writeU16aLE(void* p, uint32_t x) noexcept
{
	writeU16xLE<2>(p, x);
}
static ASMJIT_INLINE void writeU16uLE(void* p, uint32_t x) noexcept
{
	writeU16xLE<0>(p, x);
}

static ASMJIT_INLINE void writeU16aBE(void* p, uint32_t x) noexcept
{
	writeU16xBE<2>(p, x);
}
static ASMJIT_INLINE void writeU16uBE(void* p, uint32_t x) noexcept
{
	writeU16xBE<0>(p, x);
}

static ASMJIT_INLINE void writeU16a(void* p, uint32_t x) noexcept
{
	writeU16x<2>(p, x);
}
static ASMJIT_INLINE void writeU16u(void* p, uint32_t x) noexcept
{
	writeU16x<0>(p, x);
}

static ASMJIT_INLINE void writeI16aLE(void* p, int32_t x) noexcept
{
	writeI16xLE<2>(p, x);
}
static ASMJIT_INLINE void writeI16uLE(void* p, int32_t x) noexcept
{
	writeI16xLE<0>(p, x);
}

static ASMJIT_INLINE void writeI16aBE(void* p, int32_t x) noexcept
{
	writeI16xBE<2>(p, x);
}
static ASMJIT_INLINE void writeI16uBE(void* p, int32_t x) noexcept
{
	writeI16xBE<0>(p, x);
}

static ASMJIT_INLINE void writeI16a(void* p, int32_t x) noexcept
{
	writeI16x<2>(p, x);
}
static ASMJIT_INLINE void writeI16u(void* p, int32_t x) noexcept
{
	writeI16x<0>(p, x);
}
...
static ASMJIT_INLINE void writeU32aLE(void* p, uint32_t x) noexcept
{
	writeU32xLE<4>(p, x);
}
static ASMJIT_INLINE void writeU32uLE(void* p, uint32_t x) noexcept
{
	writeU32xLE<0>(p, x);
}

static ASMJIT_INLINE void writeU32aBE(void* p, uint32_t x) noexcept
{
	writeU32xBE<4>(p, x);
}
static ASMJIT_INLINE void writeU32uBE(void* p, uint32_t x) noexcept
{
	writeU32xBE<0>(p, x);
}

static ASMJIT_INLINE void writeU32a(void* p, uint32_t x) noexcept
{
	writeU32x<4>(p, x);
}
static ASMJIT_INLINE void writeU32u(void* p, uint32_t x) noexcept
{
	writeU32x<0>(p, x);
}

static ASMJIT_INLINE void writeI32aLE(void* p, int32_t x) noexcept
{
	writeI32xLE<4>(p, x);
}
static ASMJIT_INLINE void writeI32uLE(void* p, int32_t x) noexcept
{
	writeI32xLE<0>(p, x);
}

static ASMJIT_INLINE void writeI32aBE(void* p, int32_t x) noexcept
{
	writeI32xBE<4>(p, x);
}
static ASMJIT_INLINE void writeI32uBE(void* p, int32_t x) noexcept
{
	writeI32xBE<0>(p, x);
}

static ASMJIT_INLINE void writeI32a(void* p, int32_t x) noexcept
{
	writeI32x<4>(p, x);
}
static ASMJIT_INLINE void writeI32u(void* p, int32_t x) noexcept
{
	writeI32x<0>(p, x);
}
...
static ASMJIT_INLINE void writeU64aLE(void* p, uint64_t x) noexcept
{
	writeU64xLE<8>(p, x);
}
static ASMJIT_INLINE void writeU64uLE(void* p, uint64_t x) noexcept
{
	writeU64xLE<0>(p, x);
}

static ASMJIT_INLINE void writeU64aBE(void* p, uint64_t x) noexcept
{
	writeU64xBE<8>(p, x);
}
static ASMJIT_INLINE void writeU64uBE(void* p, uint64_t x) noexcept
{
	writeU64xBE<0>(p, x);
}

static ASMJIT_INLINE void writeU64a(void* p, uint64_t x) noexcept
{
	writeU64x<8>(p, x);
}
static ASMJIT_INLINE void writeU64u(void* p, uint64_t x) noexcept
{
	writeU64x<0>(p, x);
}

static ASMJIT_INLINE void writeI64aLE(void* p, int64_t x) noexcept
{
	writeI64xLE<8>(p, x);
}
static ASMJIT_INLINE void writeI64uLE(void* p, int64_t x) noexcept
{
	writeI64xLE<0>(p, x);
}

static ASMJIT_INLINE void writeI64aBE(void* p, int64_t x) noexcept
{
	writeI64xBE<8>(p, x);
}
static ASMJIT_INLINE void writeI64uBE(void* p, int64_t x) noexcept
{
	writeI64xBE<0>(p, x);
}

static ASMJIT_INLINE void writeI64a(void* p, int64_t x) noexcept
{
	writeI64x<8>(p, x);
}
static ASMJIT_INLINE void writeI64u(void* p, int64_t x) noexcept
{
	writeI64x<0>(p, x);
}
} // Utils namespace
...
union UInt64
{
	...
	ASMJIT_INLINE UInt64& operator+=(uint64_t val) noexcept
	{
		return add(val);
	}
	ASMJIT_INLINE UInt64& operator+=(const UInt64& val) noexcept
	{
		return add(val);
	}
	...
	ASMJIT_INLINE bool operator==(uint64_t val) const noexcept
	{
		return eq(val);
	}
	ASMJIT_INLINE bool operator==(const UInt64& val) const noexcept
	{
		return eq(val);
	}
