...
template<class Archive, typename T, size_t D, typename C>
inline void serialize(Archive & ar, boost::geometry::model::point<T, D, C> & o, const unsigned int version)
{
...
public:
	...
	members_holder const& members() const
	{
		return m_rtree.m_members;
	}
