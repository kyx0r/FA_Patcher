...
public:
	...
	ASMJIT_INLINE CpuFeatures() noexcept
	{
		reset();
	}
	...
	ASMJIT_INLINE void init(const CpuFeatures& other) noexcept
	{
	...
	ASMJIT_INLINE BitWord* getBits() noexcept
	{
		return _bits;
	}
	//! Get all features as `BitWord` array (const).
	ASMJIT_INLINE const BitWord* getBits() const noexcept
	{
		return _bits;
	}
...
public:
	...
	ASMJIT_INLINE void init(const CpuInfo& other) noexcept
	{
		::memcpy(this, &other, sizeof(*this));
	}
	ASMJIT_INLINE void reset() noexcept
	...
	//! Get CPU vendor ID.
	ASMJIT_INLINE uint32_t getVendorId() const noexcept
	{
		return _vendorId;
	}
	//! Get CPU family ID.
	ASMJIT_INLINE uint32_t getFamily() const noexcept
	{
		return _family;
	}
	//! Get CPU model ID.
	ASMJIT_INLINE uint32_t getModel() const noexcept
	{
		return _model;
	}
	//! Get CPU stepping.
	ASMJIT_INLINE uint32_t getStepping() const noexcept
	{
		return _stepping;
	}
	...
	ASMJIT_INLINE const CpuFeatures& getFeatures() const noexcept
	{
		return _features;
	}
	...
	ASMJIT_INLINE const char* getVendorString() const noexcept
	{
		return _vendorString;
	}
	//! Get CPU brand string.
	ASMJIT_INLINE const char* getBrandString() const noexcept
	{
		return _brandString;
	}
