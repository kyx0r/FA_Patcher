...
struct range<T, typename enable_if<is_range<T> >::type> : public range_base<T>
{
	...
	iterator       end ()
	{
		return base_type::end_;
	}
	const_iterator end () const
	{
		return base_type::end_;
	}
	sentry_type sentry () const
	{
		return base_type::end_;
	}
	std::size_t   size () const
	{
		return base_type::end_ - base_type::begin_;
	}
	bool         empty () const
	{
		return base_type::begin_ == base_type::end_;
	}
};
...
struct range<T*, typename enable_if<cnv::is_char<T> >::type> : public range_base<T*>
{
	...
	struct sentry_type
	{
		friend bool operator!=(iterator it, sentry_type)
		{
			return !!*it;
		}
	};
	...
	iterator       end ()
	{
		return base_type::end_ ? base_type::end_ : (base_type::end_ = base_type::begin_ + size());
	}
	const_iterator end () const
	{
		return base_type::end_ ? base_type::end_ : (base_type::end_ = base_type::begin_ + size());
	...
	std::size_t   size () const
	{
		return std::char_traits<value_type>::length(base_type::begin_);
	}
	bool         empty () const
	{
		return !*base_type::begin_;
	}
};
template<typename T>
