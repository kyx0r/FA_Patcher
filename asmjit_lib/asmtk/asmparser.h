...
public:
	...
	ASMJIT_INLINE asmjit::CodeEmitter* getEmitter() const
	{
		return _emitter;
	}

	ASMJIT_INLINE bool hasUnknownSymbolHandler() const
	{
		return _unknownSymbolHandler != NULL;
	}

	ASMJIT_INLINE UnknownSymbolHandler getUnknownSymbolHandler() const
	{
		return _unknownSymbolHandler;
	}
	ASMJIT_INLINE void* getUnknownSymbolHandlerData() const
	{
		return _unknownSymbolHandlerData;
	}
	...
	ASMJIT_INLINE void resetUnknownSymbolHandler()
	{
		setUnknownSymbolHandler((UnknownSymbolHandler)NULL, NULL);
	}
