...
public:
	BOOST_DEFAULTED_FUNCTION(base_atomic() BOOST_ATOMIC_DETAIL_DEF_NOEXCEPT_DECL, BOOST_ATOMIC_DETAIL_DEF_NOEXCEPT_IMPL {})
BOOST_FORCEINLINE BOOST_CONSTEXPR explicit base_atomic(value_arg_type v) BOOST_NOEXCEPT :
	m_storage(v) {}
...
BOOST_FORCEINLINE BOOST_CONSTEXPR atomic(value_arg_type v) BOOST_NOEXCEPT :
	...
	BOOST_FORCEINLINE storage_type const volatile& storage() const volatile BOOST_NOEXCEPT
	{
		return this->m_storage.value;
	}
